...
The goal of `microbiomer` is to provide a small set of tools to more seamlessly integrate tools/functions from both the [`phyloseq`](https://joey711.github.io/phyloseq/) and [`tidyverse`](https://www.tidyverse.org)ph-packages.
